...
function CheckoutPage() {
    ...
    if ($[0] !== "fd9763e9e65fa39721a2afae06f34cd83f44ee66fb4b3f49f68ee7eec08f0bd7") {
        for(let $i = 0; $i < 79; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "fd9763e9e65fa39721a2afae06f34cd83f44ee66fb4b3f49f68ee7eec08f0bd7";
    }
    const { cart, removeFromCart, updateItemDocument, placeOrder, isUploading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$CartContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"])();
    const { user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const [error, setError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [paymentMethod, setPaymentMethod] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("pix");
    if (cart.length === 0) {
        let t0;
        let t1;
        if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
            t0 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "inline-block p-6 rounded-full bg-slate-800/50 backdrop-blur mb-6",
        ...
        if ($[3] !== router) {
            t2 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "max-w-4xl mx-auto px-4 py-32 text-center text-white",
                children: [
                    t0,
                    t1,
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        onClick: {
                            "CheckoutPage[<button>.onClick]": ()=>router.push("/services")
                        }["CheckoutPage[<button>.onClick]"],
                        className: "text-sky-400 hover:text-sky-300 font-medium hover:underline text-lg",
    ...
    let t0;
    if ($[5] !== paymentMethod || $[6] !== placeOrder || $[7] !== router || $[8] !== user) {
        t0 = ({
            "CheckoutPage[handleFinishOrder]": async ()=>{
                if (!user) {
                    router.push("/login");
                    return;
                }
        ...
        })["CheckoutPage[handleFinishOrder]"];
        $[5] = paymentMethod;
        $[6] = placeOrder;
        $[7] = router;
        $[8] = user;
    ...
    const handleFinishOrder = t0;
    let t1;
    if ($[10] !== updateItemDocument) {
        t1 = ({
            "CheckoutPage[handleFileChange]": (cartId, docName, event)=>{
                if (event.target.files && event.target.files[0]) {
                    updateItemDocument(cartId, docName, event.target.files[0]);
                    setError(null);
                }
            }
        })["CheckoutPage[handleFileChange]"];
        $[10] = updateItemDocument;
        $[11] = t1;
    } else {
        t1 = $[11];
    }
    const handleFileChange = t1;
    let t10;
    let t11;
    let t12;
    let t13;
    ...
    let t8;
    let t9;
    if ($[12] !== cart || $[13] !== error || $[14] !== handleFileChange || $[15] !== isUploading || $[16] !== paymentMethod || $[17] !== removeFromCart) {
        const total = cart.reduce(_CheckoutPageCartReduce, 0);
        t9 = "max-w-5xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 py-12 animate-fade-in";
        if ($[31] === Symbol.for("react.memo_cache_sentinel")) {
            t10 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                ...
                children: "📋 Finalizar Solicitação"
            }, void 0, false, {
                fileName: "[project]/src/app/checkout/page.tsx",
                lineNumber: 120,
                columnNumber: 13
        ...
        if ($[32] !== error) {
            t11 = error && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "bg-red-500/10 backdrop-blur border border-red-500/50 text-red-200 px-6 py-4 rounded-xl mb-8 flex items-center gap-3 shadow-lg",
                children: [
        ...
        if ($[34] !== isUploading) {
            t12 = isUploading && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "fixed inset-0 bg-slate-900/90 backdrop-blur-md z-50 flex flex-col items-center justify-center",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$loader$2d$circle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Loader2$3e$__["Loader2"], {
                        className: "h-16 w-16 text-sky-400 animate-spin mb-6"
                    }, void 0, false, {
                        fileName: "[project]/src/app/checkout/page.tsx",
                        lineNumber: 133,
                        columnNumber: 139
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: "Criptografando e salvando na nuvem. Aguarde."
                    }, void 0, false, {
                        fileName: "[project]/src/app/checkout/page.tsx",
                        lineNumber: 133,
                        columnNumber: 276
        ...
        if ($[36] === Symbol.for("react.memo_cache_sentinel")) {
            t15 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$circle$2d$alert$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__AlertCircle$3e$__["AlertCircle"], {
                className: "h-5 w-5 text-sky-400 shrink-0 mt-0.5"
            }, void 0, false, {
                fileName: "[project]/src/app/checkout/page.tsx",
                lineNumber: 141,
                columnNumber: 13
        ...
        if ($[37] === Symbol.for("react.memo_cache_sentinel")) {
            t13 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "bg-sky-600/10 border border-sky-500/30 rounded-xl p-4 flex items-start gap-3",
                    children: [
                        t15,
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: [
                                ...
                                " Você pode enviar os documentos agora ou adicionar depois no seu painel de cliente. Não é necessário completar tudo agora."
                            ]
                        }, void 0, true, {
                            fileName: "[project]/src/app/checkout/page.tsx",
                            lineNumber: 147,
        ...
        let t16;
        if ($[38] !== cart || $[39] !== handleFileChange || $[40] !== removeFromCart) {
            let t17;
            if ($[42] !== handleFileChange || $[43] !== removeFromCart) {
                t17 = ({
                    "CheckoutPage[cart.map()]": (item_0, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "glass-panel rounded-2xl overflow-hidden shadow-lg transition-all hover:shadow-xl",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "bg-sky-50/10 backdrop-blur px-4 sm:px-6 md:px-8 py-4 border-b border-sky-500/20 flex flex-col md:flex-row items-start md:items-center gap-4",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "flex-1 min-w-0",
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                                    className: "font-bold text-white text-lg sm:text-xl flex items-center gap-3",
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            className: "bg-sky-600 text-white w-7 h-7 rounded-lg text-sm flex items-center justify-center shadow-md shadow-sky-500/30",
                                                            children: index + 1
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/app/checkout/page.tsx",
                                                            lineNumber: 157,
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    ...
                                                    children: item_0.category === "insurance" ? "\uD83D\uDEE1\uFE0F Seguro" : item_0.category === "license" ? "\uD83D\uDCDC Licen\xE7a" : "\uD83D\uDCDD Documenta\xE7\xE3o"
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/checkout/page.tsx",
                                                    lineNumber: 157,
                                                    columnNumber: 644
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    className: "font-bold text-sky-300 text-lg sm:text-xl",
                                                    children: [
                                                        "R$ ",
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                    onClick: {
                                                        "CheckoutPage[cart.map() > <button>.onClick]": ()=>removeFromCart(item_0.cartId)
                                                    }["CheckoutPage[cart.map() > <button>.onClick]"],
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            className: "text-sm font-semibold text-sky-300 mb-5 uppercase tracking-wide",
                                            children: "📎 Anexe os documentos (opcional):"
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/checkout/page.tsx",
                                            lineNumber: 159,
                                            columnNumber: 259
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: item_0.requiredDocuments.map({
                                                "CheckoutPage[cart.map() > item_0.requiredDocuments.map()]": (doc)=>{
                                                    const isUploaded = !!item_0.uploadedDocs[doc];
                                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: `border rounded-xl p-4 transition-all duration-300 min-h-[110px] flex flex-col justify-between ${isUploaded ? "border-sky-400/50 bg-sky-500/10" : "border-slate-600 bg-slate-800/50 hover:bg-slate-800"}`,
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                className: "flex justify-between items-start mb-3",
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                                        className: "text-sm font-bold text-slate-200 block max-w-[85%] leading-tight",
                                                                        children: doc
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/src/app/checkout/page.tsx",
                                                                        lineNumber: 162,
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                                        type: "file",
                                                                        id: `file-${item_0.cartId}-${doc}`,
                                                                        className: "hidden",
                                                                        onChange: {
                                                                            "CheckoutPage[cart.map() > item_0.requiredDocuments.map() > <input>.onChange]": (e)=>handleFileChange(item_0.cartId, doc, e)
                                                                        }["CheckoutPage[cart.map() > item_0.requiredDocuments.map() > <input>.onChange]"]
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/src/app/checkout/page.tsx",
                                                                        lineNumber: 162,
                                                                        columnNumber: 557
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                                        htmlFor: `file-${item_0.cartId}-${doc}`,
                                                                        className: `w-full flex items-center justify-center gap-2 py-3 px-4 rounded-lg border text-sm font-bold cursor-pointer transition-all ${isUploaded ? "border-sky-400/50 text-sky-300 bg-sky-500/10" : "border-slate-600 text-slate-400 hover:text-sky-400 hover:border-sky-400/50 hover:bg-sky-500/5"}`,
                                                                        children: isUploaded ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                                                            children: [
                                                                                ...
                                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                                    ...
                                                                                    children: item_0.uploadedDocs[doc]?.name
                                                                                }, void 0, false, {
                                                                                    fileName: "[project]/src/app/checkout/page.tsx",
                                                                                    lineNumber: 164,
                                                                                    columnNumber: 504
                                            ...
                                            }["CheckoutPage[cart.map() > item_0.requiredDocuments.map()]"])
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/checkout/page.tsx",
                                            lineNumber: 159,
                                            columnNumber: 376
            ...
            t8 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: t18.map({
                            "CheckoutPage[(anonymous)()]": (method)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                            ...
                                            onChange: {
                                                "CheckoutPage[(anonymous)() > <input>.onChange]": (e_0)=>setPaymentMethod(e_0.target.value)
                                            }["CheckoutPage[(anonymous)() > <input>.onChange]"],
                                            className: "sr-only"
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/checkout/page.tsx",
                                            lineNumber: 206,
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: `p-4 rounded-lg border-2 transition-all text-center font-semibold ${paymentMethod === method ? "border-sky-400 bg-sky-500/20 text-sky-300" : "border-slate-600 bg-slate-800/50 text-slate-400 hover:border-slate-500"}`,
                                            children: [
                                                method === "pix" && "\uD83D\uDCF2 PIX",
                                                method === "whatsapp" && "\uD83D\uDCAC WhatsApp",
                                                method === "card" && "\uD83D\uDCB3 Cart\xE3o",
        ...
        t6 = "bg-gradient-to-r from-sky-600/20 to-cyan-600/20 border border-sky-500/30 rounded-2xl p-8 flex flex-col md:flex-row items-center justify-between gap-6";
        ...
        t2 = "text-4xl font-black text-sky-300";
        t3 = "R$ ";
        t4 = total.toFixed(2);
        $[12] = cart;
        $[13] = error;
    ...
    let t18;
    if ($[60] !== handleFinishOrder || $[61] !== isUploading) {
    ...
    let t21;
    if ($[71] !== t10 || $[72] !== t11 || $[73] !== t12 || $[74] !== t13 || $[75] !== t14 || $[76] !== t20 || $[77] !== t9) {
...
_s(CheckoutPage, "a62q9YuMQPtWrBJfFYAKmSc94DE=", false, function() {
    return [
...
_c = CheckoutPage;
function _CheckoutPageCartReduce(acc, item) {
...
//# sourceMappingURL=_e958eb40._.js.map