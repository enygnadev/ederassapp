...
async function initializeFirestoreProducts() {
    try {
        ...
        console.log(`✅ ${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$defaultServices$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_SERVICES"].length} serviços adicionados ao Firestore`);
    } catch (error) {
